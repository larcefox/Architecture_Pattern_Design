...
class User(abc.ABC):
    ...
    @staticmethod
    def create(user_types, user_type, user_login, user_password, user_level, user_category):
        ...
        return user_types[user_type](user_login, user_password, user_level, user_category)